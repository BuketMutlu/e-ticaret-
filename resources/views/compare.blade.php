            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    ...
                    <div class="header-logo">
                        <a href="/"><img src="assets/images/logo.png" width="154" height="46" alt="Logo" /></a>
                    </div>
                    <!-- Header Logo End -->
                </div>
                <div class="col-lg-6">
                        ...
                        <ul class="nav-menu">
                                ...
                                <ul class="mega-sub-menu">
                                    <li>
                                        ...
                                        <ul class="menu-item">
                                            ...
                                            <li>
                                                <a href="/kategori">Shop Grid Left Sidebar</a>
                                            </li>
                                            <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu-item">
                                            <li><a href="/urundetay">Product Details</a></li>
                                            <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="menu-item">
                                            ...
                                            <li><a href="/begenilen">Wishlist</a></li>
                                            <li><a href="/ödeme">Checkout</a></li>
                                            <li><a href="/hesabım">My Account</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="/begenilen">Wishlist</a></li>
                                    <li><a href="empty-/kart">Empty Cart</a></li>
                                    <li><a href="/ödeme">Checkout</a></li>
                                    <li><a href="/hesabım">My Account</a></li>
                                    <li><a href="/giris">Login</a></li>
                                    <li><a href="/kayıt">Register</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="#">Blog</a>
                    ...
                    <div class="header-meta">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-profile">
                                <li><a href="/hesabım">My Account</a></li>
                                <li><a href="/ödeme">Checkout</a></li>
                                <li><a href="/giris">Sign In</a></li>
                            </ul>
                        </div>
                        <a class="action" href="/begenilen"><i class="pe-7s-like"></i></a>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-cart">
                                    ...
                                    <ul>
                                            ...
                                            <div class="single-cart-item">
                                                ...
                                                <div class="cart-item-content">
                                                    <h6 class="product-name">
                                                        <a href="/urundetay">High quality vase
                                                            bottle</a>
                                                    </h6>
                                        ...
                                        <li>
                                            ...
                                            <div class="single-cart-item">
                                                ...
                                                <div class="cart-item-content">
                                                    <h6 class="product-name">
                                                        <a href="/urundetay">Living & Bedroom
                                                            Chair</a>
                                                    </h6>
                                                    <span class="product-price"
                                                    >$19.12</span>
                                        ...
                                        <li>
                                            ...
                                            <div class="single-cart-item">
                                                ...
                                                <div class="cart-item-content">
                                                    <h6 class="product-name">
                                                        <a href="/urundetay">Herman Arm Grey
                                                            Chair</a>
                                                    </h6>
                                                    <span class="product-price"
                                                    >$19.12</span>
                                ...
                                <div class="checkout-btn">
                                    <a href="/ödeme" class="btn btn-dark btn-hover-primary d-block">Checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="header-meta">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-profile">
                                    <li>
                                        <a href="/hesabım">My Account</a>
                                    </li>
                                    <li><a href="/ödeme">Checkout</a></li>
                                    <li><a href="/giris">Sign In</a></li>
                                </ul>
                            </div>
                            <a class="action" href="/kart">
                                <i class="pe-7s-shopbag"></i>
                                <span class="number">3</span>
                            </a>
                        </div>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasMenu">
        <div class="offcanvas-header">
            ...
            <div class="canvas-action">
                ...
                <a class="action" href="/begenilen"><i class="icon-heart"></i> Wishlist
                    <span class="action-num">(3)</span></a>
            </div>
            <!-- Canvas Action end -->
                                ...
                                <td>
                                    <div class="compare-product">
                                        <div class="pack-product-container">
                                            ...
                                            <div class="desc-box">
                                                <a class="product-name" href="/urundetay">High quality vase
                                                    bottle</a>
                                ...
                                <td>
                                    <div class="compare-product">
                                        <div class="pack-product-container">
                                            <div class="thumb-mask">
                                                <a href="/urundetay">
                                                    <img src="assets/images/product/product-08.jpg" alt="Product" />
                                                </a>
                                            </div>
                                            <div class="desc-box">
                                                <a class="product-name" href="/urundetay">Herman Seater Sofa</a>
                                                <div class="product-reviews">
                                                    <div class="review-star">
                                                        <div class="star" style="
                                                                    width: 80%;
                                ...
                                <td>
                                    <div class="compare-product">
                                        <div class="pack-product-container">
                                            <div class="thumb-mask">
                                                <a href="/urundetay">
                                                    <img src="assets/images/product/product-13.jpg" alt="Product" />
                                                </a>
                                            </div>
                                            <div class="desc-box">
                                                <a class="product-name" href="/urundetay">Wood Dining Table</a>
                                                <div class="product-reviews">
                                                    <div class="review-star">
                                                        <div class="star" style="
                                                                    width: 80%;
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        ...
                        <div class="footer-widget">
                            ...
                            <ul class="footer-link">
                                <li><a href="/kayıt">Sign In</a></li>
                                <li><a href="/kart">View Cart</a></li>
                                <li><a href="/begenilen">My Wishlist</a></li>
